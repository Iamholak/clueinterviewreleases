  ...
  const downloadOptions = [
    {
      ...
      version: 'v1.2.5',
      url: 'https://github.com/Iamholak/clueinterviewreleases/releases/download/v1.2.5/Clue-Interview-Setup-1.2.5.exe',
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="https://github.com/Iamholak/clueinterviewreleases/releases/download/v1.2.5/Clue-Interview-Setup-1.2.5.exe"
